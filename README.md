...
- **[Custom Syntax Extensions](docs/syntax.md)** — support for links, todos, margin marks, and BEAT-style color coding.
...
- **Comprehensive [Syntax Guide](docs/syntax.md)** for all plugin-specific and BEAT-compatible extensions.

## Command reference

See here [Command Reference](https://github.com/bgrundmann/obsidian-fountain/blob/main/docs/COMMAND_REFERENCE.md).
